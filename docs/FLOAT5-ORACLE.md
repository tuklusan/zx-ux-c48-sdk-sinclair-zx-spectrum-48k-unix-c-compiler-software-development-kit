...
============================================================================
-->
# Float5 Oracle Boundary - 1.0.0 Host SDK
...
## What the 1.0.0 host SDK implements and tests
...
is still outside this 1.0.0 host SDK's certified envelope. See `CONFORMANCE.md`.
...
The 1.0.0 host SDK may therefore claim a default ROM-derived host implementation
