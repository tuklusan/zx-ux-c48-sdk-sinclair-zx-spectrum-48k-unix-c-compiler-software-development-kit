...
- Current 1.0.0 full unittest corpus: **340 tests**.
- Local full unittest corpus: **PASS, 340 tests**.
...
1.0.0 unittest count at 340. The release workflow runs the complete verifier
