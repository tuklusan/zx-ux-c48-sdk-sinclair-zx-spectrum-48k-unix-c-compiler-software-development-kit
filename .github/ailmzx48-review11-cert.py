...
EXPECTED = "258ad19d6d5c3e4f7bc0f7ab1d15f1689d3f2cea"
actual = subprocess.check_output(
    ["git", "hash-object", str(DESIGN)], text=True
).strip()
if actual != EXPECTED:
    raise SystemExit(f"reviewed design blob changed: {actual}")
...
"""
CERT.write_text(content, encoding="utf-8", newline="\n")
